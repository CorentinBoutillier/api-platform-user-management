...
/**
 * Class CustomJWTTokenAuthenticator
 * @package App\Security\Guard
 *
 * @author Corentin Boutillier <corentinboutillier@gmail.com>
 */
class CustomJWTTokenAuthenticator extends AbstractGuardAuthenticator
{
    /**
    ...
    public function getUser($preAuthToken, UserProviderInterface $userProvider)
    {
        ...
        try {
            ...
            if (!$user->getValidatedEmail()) {
                throw new CustomUserMessageAuthenticationException('Please confirm your mail address.');
            } elseif (!$user->getEnabled()) {
                throw new CustomUserMessageAuthenticationException('Desactivated account.');
            }
